...
Please, before creating this issue make sure that you read the [README](https://github.com/FriendsOfShopware/default-plugin-repo/blob/master/README.md), that you are running the latest stable version of this plugin and that you already searched [other issues](https://github.com/FriendsOfShopware/FroshEnvironmentNotice/issues?q=is%3Aissue+is%3Aopen+is%3Aclosed) to see if your problem or request was already reported.
...
- [ ] I have checked [all issues](https://github.com/FriendsOfShopware/FroshEnvironmentNotice/issues?q=is%3Aissue+is%3Aopen+is%3Aclosed) and haven't found a similar report.
